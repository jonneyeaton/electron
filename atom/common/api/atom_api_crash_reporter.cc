...
void Initialize(v8::Local<v8::Object> exports,
  ...
  SetMethod(exports, "start", base::Bind(&CrashReporter::Start, reporter));
  SetMethod(exports, "addExtraParameter",
            base::Bind(&CrashReporter::AddExtraParameter, reporter));
  SetMethod(exports, "removeExtraParameter",
            base::Bind(&CrashReporter::RemoveExtraParameter, reporter));
  SetMethod(exports, "getParameters",
            base::Bind(&CrashReporter::GetParameters, reporter));
